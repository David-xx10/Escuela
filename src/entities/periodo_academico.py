class PeriodoAcademico:
    def __init__(self, id_periodo: int, nombre: str, fecha_inicio: str, fecha_fin: str):
        if not isinstance(id_periodo, int) or id_periodo <= 0:
    ...
    def __str__(self):
        return f"Periodo {self.id_periodo}: {self.nombre} ({self.fecha_inicio} - {self.fecha_fin})"