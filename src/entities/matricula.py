class Matricula: 
    def __init__(self, id_matricula: int, id_alumno: int, id_curso: int, fecha_matricula: str):
        ...
        if not isinstance(id_alumno, int) or id_alumno <= 0:
            raise ValueError("El id del alumno debe ser un número entero positivo.")
